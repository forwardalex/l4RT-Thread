...
#include "../drv/MPL/mllite/invensense.h"
#include "../drv/MPL/mpl/invensense_adv.h"
#include "../drv/MPL/eMPL-hal/eMPL_outputs.h"
...
/**
 * @brief	ICM20608初始化，MPL初始化
 *
 * @param   void
 *
 * @return  u8		0,正常，其他,失败
 */
u8 mpu_mpl_init(void)
{
	u8 res;
	unsigned char accel_fsr;
